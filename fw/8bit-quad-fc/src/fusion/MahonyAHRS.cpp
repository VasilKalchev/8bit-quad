...
#define DEFAULT_SAMPLE_FREQ	384.0f	// sample frequency in Hz
// higher - angle is just 45 insted of 90
// lower - very slow settle, very slow oscillations, overshoot
#define twoKpDef	(2.0f * 0.65f)	// 2 * proportional gain (was 0.40, then 0.7)
#define twoKiDef	(2.0f * 0.01f)	// 2 * integral gain (0.01)
...
Mahony::Mahony(float sampleFrequency)
{
...
roll = atan2(2*q1*q0-2*q2*q3 , 1 - 2*q1^2 - 2*q3^2)
yaw = atan2(2*q2*q0-2*q1*q3 , 1 - 2*q2^2 - 2*q3^2)
